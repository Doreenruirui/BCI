...
def decode():
    ...
    with tf.Session() as sess:
        ...
        for batch in batches:
            ...
            mrr, recall, perplex, acc, predict = decode_batch(sess, source_tokens, source_mask,
                                                         target_tokens)
            lid += 1
            print(lid)
            f_mrr.write(mrr)
