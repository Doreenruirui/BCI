...
tf.app.flags.DEFINE_integer("prior", '3', "The prior for dirichlet distrubution probability")
tf.app.flags.DEFINE_string("prior_vec", '3_1', "The prior for dirichlet distrubution probability")
tf.app.flags.DEFINE_string("prob_vec", '0.8_0.1', "The prior for dirichlet distrubution probability")
tf.app.flags.DEFINE_float("prob_high", 0.7, "Highest probability")
