...
class Model(object):
    ...
    def build_lstm(self, vocab_size_char):
    ...
    def decode_lstm(self, session, src_toks, src_probs, tgt_toks, src_mask):
        input_feed = {}
    ...
    def train(self, session, src_toks, src_probs, src_mask, tgt_toks, keep_prob):
        input_feed = {}
        input_feed[self.src_toks] = src_toks
        input_feed[self.src_probs] = src_probs
        input_feed[self.tgt_toks] = tgt_toks
    ...
    def test(self, session, src_toks, src_probs, src_mask, tgt_toks):
        input_feed = {}
        input_feed[self.src_toks] = src_toks
        input_feed[self.src_probs] = src_probs
        input_feed[self.tgt_toks] = tgt_toks
