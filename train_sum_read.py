...
from data_generate_sum_read import id2char, iter_data, load_data, pair_iter
...
def validate(model, sess, batches):
    ...
    for batch in batches:
        source_tokens, source_probs, source_mask, target_tokens = iter_data(batch, FLAGS.num_wit)
...
def train():
    ...
    with tf.Session() as sess:
        ...
        test_batches = []
        load_data(test_batches, FLAGS.data_dir, FLAGS.dev,
                  num_wit=FLAGS.num_wit,
